...
| [Why use RATH?](#why-use-rath) | [Try RATH](#try-rath) | [Feature highlights](#feature-highlights) | [Walkthroughs](#walkthroughs) | [Project Status](#project-status) | [Developer Documentation](#developer-documentation) | [Community](#community) | [Contributions](#contributions) | [License (AGPL)](#license-agpl) |
...
- Download the [desktop version](https://kanaries.net/#/products). Currently, RATH Supports Windows and Mac.
...
RATH can query data from any SQL-speaking datastore or data engine. Here are some of the major database solutions that are supported:
