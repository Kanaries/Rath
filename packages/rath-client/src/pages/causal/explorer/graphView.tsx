    ...
    (
        ...
        return (
            <Container {...props} ref={ref}>
                ...
                {mode === 'edit' && (
                    <div className="tools">
                        <Button variant="ghost" onClick={() => causalStore.model.clearAssertions()}>
                        ...
                        <RathSelect
                            ...
                            onChange={(key) => {
                                setCreateEdgeMode(key as typeof createEdgeMode);
                            }}
                            triggerClassName="h-[1.8em] border-0 border-b border-[#8888] px-[0.8em] pr-[2.8em] text-[0.8rem] shadow-none"
                        />
                        <RathSelect
                            ...
                            onChange={(key) => {
                                setClickEdgeMode(key as typeof clickEdgeMode);
                            }}
                            triggerClassName="h-[1.8em] border-0 border-b border-[#8888] px-[0.8em] pr-[2.8em] text-[0.8rem] shadow-none"
                        />
                        <RathSelect
                            ...
                            onChange={(key) => {
                                setDblClickNodeMode(key as typeof dblClickNodeMode);
                            }}
                            triggerClassName="h-[1.8em] border-0 border-b border-[#8888] px-[0.8em] pr-[2.8em] text-[0.8rem] shadow-none"
                        />
                    </div>
