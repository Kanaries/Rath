                                ...
                                const headerContent = (
                                    <span className="flex min-w-0 max-w-full items-center gap-1 overflow-hidden whitespace-nowrap">
                                        {column.onRenderHeader ? (
                                            <span className="min-w-0 shrink-0">{column.onRenderHeader(column)}</span>
                                        ) : (
                                ...
                                return (
                                    ...
                                    >
                                        {sortable ? (
                                            <button
                                                type="button"
                                                className="flex h-full w-full items-center text-left hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                                        ...
                                        {column.isResizable && (
                                            <button
                                                ...
                                                className="absolute inset-y-1 right-0 w-2 cursor-col-resize touch-none border-r border-transparent hover:border-ring focus-visible:border-ring focus-visible:outline-none"
                        ...
                        <>
                            {paddingTop > 0 && (
                                <TableRow aria-hidden className="border-0 hover:bg-transparent">
                                    <TableCell className="p-0" colSpan={columns.length + (selection ? 1 : 0)} style={{ height: paddingTop }} />
                                </TableRow>
                            )}
                            ...
                            {paddingBottom > 0 && (
                                <TableRow aria-hidden className="border-0 hover:bg-transparent">
                                    <TableCell className="p-0" colSpan={columns.length + (selection ? 1 : 0)} style={{ height: paddingBottom }} />
                                </TableRow>
                            )}
                        </>
                    )}
