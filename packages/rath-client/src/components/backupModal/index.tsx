            ...
            if (download) {
                ...
                if (dsId === undefined) {
                    const dataSourceSaveRes = sourceType === DataSourceType.File ? (
                        await dataSourceStore.saveDataSourceOnCloudOfflineMode({
                    ...
                    ) : await dataSourceStore.saveDataSourceOnCloudOnlineMode({
                        name: modifiableDataSourceName || defaultDataSourceName,
                        organizationName: selectedOrg!,
                        workspaceName: selectedWsp!,
                        datasourceType: sourceType,
                ...
                if (dsId) {
                    await dataSourceStore.saveDatasetOnCloud({
                        id: datasetOverwrite ? cloudDatasetId : undefined,
                        datasourceId: dsId,
