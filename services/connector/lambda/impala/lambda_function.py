...
class basefunc:
    ...
    @staticmethod
    def impala_getmeta(database, table, schema, engine=None):
    ...
    @staticmethod
    def impala_getdetail(uri, database, table, schema, rows_num):
        engine = create_engine(uri, echo=True)
    ...
    @staticmethod
    def impala_getresult(sql, uri=None, engine=None):
        if engine is None:
            engine = create_engine(uri, echo=True)
