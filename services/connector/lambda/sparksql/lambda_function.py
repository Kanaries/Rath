...
class basefunc:
    ...
    @staticmethod
    def sparksql_getmeta(database, table, schema, engine=None):
    ...
    @staticmethod
    def sparksql_getdetail(uri, database, table, schema, rows_num):
        engine = create_engine(uri, echo=True)
    ...
    @staticmethod
    def sparksql_getresult(sql, uri=None, engine=None):
        if engine is None:
            engine = create_engine(uri, echo=True)
